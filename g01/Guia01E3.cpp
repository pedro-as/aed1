...
/*
  ...
  a partir do modelo modificado (CustomRobot) em
  myKarel.hpp, com base no generico (Robot)
  Nota: Todas as definicoes irao valer para qualquer outro robo
  criado a partir dessa nova descricao de modelo.
*/
class MyRobot : public CustomRobot
{
    public:
    /*
...
A unica forma que encontrei para este programa
funcionar com myKarel.hpp foi criando uma classe,
CustomRobot, a partir do modelo generico (Robot).
A classe MyRobot, utilizada aqui, herda de CustomRobot.
Nao sei se e' uma solucao correta ou apropriada, mas
foi a saida que eu encontrei para utilizar myKarel como
dependencia.
---------------------------------------------- previsao de testes
...
Versao      Teste
 ...
 1.e3       01.(OK)     teste repetindo 1.e2, usando myKarel.hpp como dependencia
*/
