...
class MyRobot : public Robot
{
    ...
    */
    void doPartialTask()
    {
        // executar tres movimentos, colocar marcador e virar 'a esquerda
        moveN(3);
        putBeeper();
        turnLeft();
    } // end doPartialTask()
    ...
    */
    void doTask ()
    {
        ...
        turnLeft();
        moveN(2);
        putBeeper(); // colocar primeiro marcador
        turnRight();
        doPartialTask(); // colocar segundo marcador
        doPartialTask(); // // colocar terceiro marcador
