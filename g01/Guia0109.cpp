...
class MyRobot : public Robot
{
    ...
    */
    void doPartialTask()
    {
        // executar tres movimentos e virar 'a esquerda
        moveN(3);
        turnLeft();
    } // end doPartialTask()
    ...
    */
    void doTask ()
    {
        // executar quatro tarefas parciais
        doPartialTask();
        doPartialTask();
        ...
        doPartialTask();
        // testar se carrega marcador antes de tentar descarregar
        if (nbeepers() > 0)
        {
            putBeeper();
        } // end if
