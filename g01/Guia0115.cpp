...
class MyRobot : public Robot
{
    ...
    */
    ...
    /* 
      pickWhileTrue - Metodo para pegar todos os marcadores da posicao atual
    */
    void pickWhileTrue()
    {
        while (nextToABeeper())
    ...
    /* 
      putWhileTrue - Metodo para descarregar todos os marcadores
    */
    void putWhileTrue()
    {
        while (nbeepers() > 0)
    ...
    */
    void doTask ()
    {
        ...
        turnLeft();
        move();
        // pegar 3 marcadores na primeira posicao
        pickWhileTrue();
        turnLeft();
        moveN(3);
        turnRight();
        moveN(4);
        // pegar 2 marcadores na segunda posicao
        pickWhileTrue();
        move();
        turnRight();
        moveN(3);
